...
values ('Helena','Rua Zircônio')

insert into Cliente (nome, endereco)
values ('Miguel','Rua São Pedro')

insert into Cliente (nome, endereco)
values ('Arthur','Rua Zircônio')

insert into Cliente (nome, endereco)
values ('Gael','Rua Jalaliel')

insert into Cliente (nome, endereco)
values ('Miguel','Rua Varna')

insert into Cliente (nome, endereco)
values ('Laura','Rua Zircônio')

insert into Cliente (nome, endereco)
values ('Miguel','Rua São Pedro')

insert into Cliente (nome, endereco)
values ('Arthur','Rua da Coleirinha')

insert into Cliente (nome, endereco)
values ('Arthur','Rua Jalaliel')

insert into Cliente (nome, endereco)
values ('Heitor','Rua São Pedro')